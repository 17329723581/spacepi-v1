const locale = {
	...
	car: [{
		...
		content: 'Token dolaşımının değerini bahşedin, daha fazla insanın SpacePi nin ekolojik yapısına katılmasına izin verin, sınırsız bir eğlence dünyası yaratın, dünyanın her köşesindeki kullanıcıları birbirine bağlayın ve küresel kullanıcılar için güvenilir ve oldukça merkezi olmayan bir metaverse ekolojisi kurun.'
	}],
	station: {
		enter: 'Güçlü SpacePi Ekosistemi',
		title: 'Aslında daha önce hiç olmadığı kadar dijital bir dünya inşa ediyoruz.',
		text: [
			'Dijital ekonomi, kısa vadede katlanarak artan, yatırımcıların dikkatine değer meşru bir varlık türü haline geldi.',
			'Bu bakış açısına dayanarak, ekosisteminde sanal varlık veya hizmet satın almak için bir yatırım aracı haline gelen SpacePi, SpacePi uygulamasıyla yeni bir canlılık ve eşi görülmemiş bir değerle patlayacak. İşte SpacePi ekosisteminin bazı önemli noktaları.'
		],
		c: [{
			title: 'Uzay Pi Simgesi',
			text: 'Güçlü uygulama senaryoları ile çeşitli uygulamalara hizmet veren, SpacePi ekosisteminde bir temel görevi gören, birden fazla genel zincir tarafından desteklenen yeni bir yardımcı program belirteci türü'
		}, {
			title: 'SpacePi ye Giriş',
			text: 'SpacePi ekosistemi WEB3.0 holografik İnternet NFT ve diğer teknik bileşenlere dayanmaktadır ve Metaverse in sanal alanında uzay kullanıcıları için en güçlü teknik destekçi haline gelmiştir.'
		}, {
			title: 'SpacePi NFT leri',
			text: 'Eşsiz özelliklere sahip homojen olmayan ve aktarılabilir dijital varlıklar, SpacePi ekosisteminde bir sanat koleksiyonu veya oyun desteği olabilir.'
		}, {
			title: 'SpacePi DAO',
			text: 'SpacePi belirteci, projenin kendi kendini idame ettirmesini ve kontrolör içermemesini sağlamak için SpacePi ekosistemindeki DAO da oy vermek için kullanılacaktır.'
		}, {
			title: 'SpacePi Metaverse',
			text: 'SpacePi Ekosisteminde Oyunlaştırılmış 3D Metaverse Sanal Alanı'
		}, {
			title: 'NFT pazarı',
			text: 'SpacePi Marketplace, katılımcıların dolaşımdaki para birimi olarak SpacePi de fiyatlandırılan SpacePi NFT lerini yönetmelerini ve ticaretini yapmalarını sağlar.'
		}]
	},
	car1: [{
		text: 'Pi Network',
	...
	ROADMAPtext: "SpacePi ekosistemini doğumdan büyüklüğe getiren plan budur.",
	Phase1: "ilk aşama",
	Phase2: "ikinci sahne",
	r_title1: "ONE",
	r_title2: "TWO",
	...
	rt2_text4: "1000K+ jeton sahibi",
	rt2_text5: "SpacePiSwap geliştirmeye başlayın",
	rt2_text6: "SpacePiNFT'nin geliştirilmesine başlayın",
	rt2_text7: "PiDAO'yu Başlat",
	rt2_text8: "Zincirler arası toplama işlem protokolü SpacePiSwap'ı başlattı",
	...
	//友情合作商页面
	partners_title:'SpacePi her zaman Pi Network ün inançlı bir hayranı olacak!',
	partners_text:'SpacePi nin şu anda yaptığı her şey, Pi Fanlarının ısrarının buna değdiğini kanıtlamak için! SpacePi ile işbirliği yapacak daha fazla platforma ve kuruma hoş geldiniz, resmi iletişim e-postası: pi@space-pi.com'
